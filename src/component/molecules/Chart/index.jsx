...
export default function EarningsChart({ data, onYearChange, loading = false }) {
  ...
  // Show NoData component if there's no data
  if (!hasData) {
    return (
      <BorderWrapper>
        <div className={classes.header}>
          <div>
            <h2 className={classes.amount}>£0.00</h2>
        ...
        <div className={classes.chartContainer}>
          {loading ? (
            ...
            <NoData text={`No data found for ${selectedYear}`} />
          )}
        </div>
      </BorderWrapper>
    );
